...
// positioning of elements inside popup should be controlled here
Widget popupBody({Widget body = const Text('body text'),
EdgeInsetsGeometry padding = const EdgeInsets.only(left: 100.0, top: 32.0, right: 0,bottom: 32.0),})
{
